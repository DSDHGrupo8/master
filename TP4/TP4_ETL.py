...
#dataconversions={'Census_IsSecureBootEnabled': str, 'SmartScreen':str,'Census_OSArchitecture':str}

#df = pd.read_csv('c:\\TEST\\TP4\\train.csv',usecols=fields,nrows=5000,dtype=dataconversions)

df = pd.read_csv('c:\\TEST\\TP4\\train.csv',usecols=fields,nrows=50000)
...
df.to_csv("c:\\TEST\\TP4\\train_clean.csv")