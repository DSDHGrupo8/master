...
df=pd.read_csv("train.csv", encoding="utf-8", dtype=dtypes)
...
pickle_write_end=datetime.datetime.now()
...
print("output pickle read time (secs):", str((pickle_write_end-pickle_write_start).total_seconds()))